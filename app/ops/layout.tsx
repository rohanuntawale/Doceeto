...
const nav: NavItem[] = [
  { href: "/ops", label: "Overview",icon: <LayoutDashboard className="h-4 w-4" /> },
  { href: "/ops/doctors", label: "Doctors",icon: <Users className="h-4 w-4" /> },
  { href: "/ops/orders", label: "AuraMed",icon: <Pill className="h-4 w-4" /> },
];
