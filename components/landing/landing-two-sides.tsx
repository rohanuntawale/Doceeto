...
import { ArrowRight, HeartHandshake, UserCheck, Stethoscope, CheckCircle2 } from "lucide-react";
import { Button } from "@/components/ui/button";

export function LandingTwoSides() {
  return (
    <section id="patient-doctor" className="py-28 sm:py-36 bg-[var(--bg)]">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="flex flex-col items-start max-w-3xl mb-16">
          ...
          <p className="mt-4 text-lg text-[var(--text-muted)] leading-relaxed">
            Doceeto eliminates fragmented onboarding. Pick your role to enter your dedicated experience through a unified door.
          </p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-12 items-stretch">
          ...
          <motion.div
            ...
            className="lg:col-span-7 rounded-[2.5rem] border-2 border-transparent bg-[var(--accent)] p-8 sm:p-10 text-[var(--c-on-accent)] flex flex-col justify-between shadow-card relative overflow-hidden group"
          >
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-xs font-mono font-bold text-white/80">ROLE 01</span>
              </div>

              <h3 className="font-serif text-3xl sm:text-4xl font-extrabold tracking-tight leading-tight text-white">
                Start with what you need. <br />Care comes directly to you.
              </h3>

              <p className="mt-5 text-base sm:text-lg text-white/90 leading-relaxed max-w-xl font-sans">
                Express symptoms, view certified doctors and home-visit nurses in your area, and book care without navigating confusing clinic phone systems.
              </p>
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  <span className="inline-flex items-center gap-2 rounded-full bg-[var(--accent)]/10 px-3.5 py-1 text-xs font-semibold uppercase tracking-wider text-[var(--accent)] border border-[var(--accent)]/20">
                    <UserCheck className="w-4 h-4" /> For Doctors
                  </span>
                  <span className="text-xs font-mono font-bold text-[var(--text-faint)]">ROLE 02</span>
                </div>
                ...
                <p className="mt-3 text-sm text-[var(--text-muted)] leading-relaxed">
                  Publish your credentials, set consultation fees, and accept verified patient requests on your schedule.
                </p>
              </div>
              ...
              <div className="mt-6 pt-4 border-t border-[var(--border)]">
                <Link href="/signup?as=doctor">
                  <Button
                    variant="outline"
                    size="lg"
                    className="w-full h-12 text-sm font-semibold border-2 border-[var(--border)] text-[var(--text)] hover:border-[var(--accent)] hover:bg-[var(--accent)]/10"
                  >
                    I&apos;m a doctor →
                  </Button>
                </Link>
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs font-mono font-bold text-[var(--text-faint)]">ROLE 03</span>
                </div>
                ...
                <p className="mt-3 text-sm text-[var(--text-muted)] leading-relaxed">
                  Provide essential home-visit care including dressing, vitals, post-op support, and elderly assistance.
                </p>
              </div>
