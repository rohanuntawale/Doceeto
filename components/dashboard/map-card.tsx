          ...
          <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
            ...
            <div className="ml-auto flex min-w-0 items-center gap-1.5 sm:gap-2">
              <button
                ...
                className="pointer-events-auto inline-flex min-w-0 max-w-[8.5rem] items-center gap-1.5 rounded-full border border-[var(--border)] bg-[var(--glass-bg-strong)] px-2.5 py-1.5 text-left text-[11px] font-medium text-cream backdrop-blur-md disabled:cursor-default sm:max-w-[10rem]"
              >
                {requesting || geo.status === "locating" ? (
                  <LoaderCircle className="h-3.5 w-3.5 shrink-0 animate-spin text-[rgb(var(--c-terracotta))]" />
                ) : (
              ...
              <button
                ...
                className="pointer-events-auto flex shrink-0 items-center gap-1.5 rounded-full bg-primary px-2.5 py-1 text-[11px] font-semibold text-on-accent sm:px-3.5 sm:py-1.5 sm:text-xs"
              >
